...
const screenshotImages = [
  { src: '/img/gravity-r-1-800x470.png', alt: 'Gravity Reconstruction #1' },
  { src: '/img/gravity-r-2-800x470.png', alt: 'Gravity Reconstruction #2' },
];

export default function VerticalGravityGradientReconstructionPage() {
  return (
    <main className="portal-page">
      <SiteHeader />
      <div className="container portal-content legacy-content">
        <h1 style={{ textAlign: 'center' }}>Global Free-Air Gravity Anomalies Reconstruction</h1>

        <ScreenshotCarousel images={screenshotImages} label="VGG Reconstruction screenshots" />
        ...
        <p>
          Press the button below to explore the reconstruction within your web browser using an interactive 3D
          visualisation{' '}
        ...
        <p style={{ textAlign: 'center' }}>
          <a className="legacy-success-btn" href="/cesium/?view=VGG-R" target="_blank" rel="noreferrer">
            Gravity Anomalies Reconstruction
          </a>
        </p>
